      ...
      <div class="container">
         <div class="page-content">
            ...
            <div class="bg-white rounded-2 shadow-sm pt-4 px-4 pb-3 mb-5">
               <!-- form -->
               <form action="process-update-car.php" method="post">
                  ...
                  <div class="mb-3 row align-items-center">
                     <label for="model" class="col-sm-2 form-label">Model Car</label>
                     <div class="col-sm-10">
                        <input type="text" class="form-control" name="model" id="model" value="<?= $data['model'] ?>">
                     </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                     <label for="harga" class="col-sm-2 form-label">Price Car</label>
                     <div class="col-sm-10">
                  ...
                  <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1 offset-lg-2 offset-md-2">
                     ...
                     <a href="cars.php" class="btn btn-outline-secondary py-2 px-3">Cancel</a>
                  </div>
