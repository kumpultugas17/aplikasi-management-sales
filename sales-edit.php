      ...
      <div class="container">
         <div class="page-content">
            ...
            <div class="bg-white rounded-2 shadow-sm pt-4 px-4 pb-3 mb-5">
               <!-- form -->
               <form action="process-update-sales.php" method="post">
                  <!-- get id dari database -->
                  <input type="hidden" name="id" value="<?= $id ?>">
                  <div class="mb-3 row align-items-center">
                     <label for="name_sales" class="col-sm-2 form-label">Name Sales</label>
                     <div class="col-sm-10">
                        <input type="text" class="form-control" name="name_sales" id="name_sales" value="<?= $data['name'] ?>">
                     </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                     <label for="email_sales" class="col-sm-2 form-label">Email Sales</label>
                     <div class="col-sm-10">
                        <input type="text" class="form-control" name="email_sales" id="email_sales" value="<?= $data['email'] ?>">
                     </div>
                  </div>
                  <div class="mb-3 row align-items-center">
                     <label for="phone_number" class="col-sm-2 form-label">Phone Number</label>
                     <div class="col-sm-10">
                        <input type="text" class="form-control" name="phone_number" id="phone_number" value="<?= $data['phone'] ?>">
                     </div>
                  </div>
